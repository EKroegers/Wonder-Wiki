...
export function NewSchoolsOfMagic() {
  return (
    <section>
      ...
      <p>
        Likewise, Occult spellcasters have no need to worry about their spells
        having wills of their own, as they are likely already painfully aware of
        the strongly opinionated higher beings from which they borrow their
        power.
      </p>
      <h2>Druidism</h2>
      <p>
        Druidic magic has been lost to time. The Druids were a traditionally
        hermetic people on Elysium, and when they disappeared from the world the
        secret of their magic disappeared along with them. It is not known what
        happened to the Druidic people.
      </p>
      <h2>Sorcery</h2>
      <p>
        Sorcerers are exceedingly rare, to be born with an innate connection to
        magical forces as a mortal in this setting is an alien concept. It is
        theorized that only a handful of sorcerers exist across the entire
        universe.
      </p>
      <br />
      <h2>Edge Cases</h2>
      <p>
        The following spells have been reclassified into the new schools of
        magic;
      </p>
      <p>
        <i>
          Please note that this list is by no means comprehensive, if you find
          content that is not on this list in any category then feel free to
